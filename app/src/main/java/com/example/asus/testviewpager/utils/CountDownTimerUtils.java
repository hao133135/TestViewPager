...
/**
  ...
  */
   ...
   public void onFinish() {
            ...
            mTextView.setBackgroundResource(R.drawable.selector_ac_register_btn_state);  //还原背景色
        }
  }
/*bg_identify_code_normal);  //还原背景色
* bg_identify_code_press); //设置按钮为灰色，这时是不能点击的
* selector_ac_register_btn_state 是验证码按钮原来的颜色引用
* */